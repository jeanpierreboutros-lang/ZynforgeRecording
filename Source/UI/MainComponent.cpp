...
// File-local copy -- the cue extraction needs its own (the static
// gives each TU internal linkage so duplicate inline copies don't
// violate ODR). When the session-IO cluster gets extracted next this
// should move into a shared Source/UI/SessionProjPath.h.
