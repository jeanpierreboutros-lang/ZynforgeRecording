...
void MainComponent::showUserGuide()
{
    ...
    const juce::String body = juce::String::fromUTF8 (
        ...
        "Wheel scrolls tracks; Shift+wheel or a horizontal trackpad gesture "
        "pans time. Cmd+wheel zooms time; Cmd+Shift+wheel zooms waveform "
        "height. H+/H- and V+/V- are the matching zoom buttons. During "
        "recording or playback, panning or time zoom pauses auto-follow; "
        "click FOLLOW to return to the live playhead. To punch into an existing "
        "take, play to the entry point and press RECORD; press RECORD or STOP "
        "once to punch out into the same track file. When stopped, click an "
        "EDIT cursor first to choose a punch point. At the take's end, "
        "RECORD instead appends a continuation part.\n\n"
