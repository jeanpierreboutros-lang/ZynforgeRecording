...
**Latest source build (2026-09-24):** the live EDIT navigation and punch/recovery/import fixes build as a macOS-12 universal Release and pass **387 test groups / 0 failures** locally. The previously verified `ccd755e` app remains installed at `/Applications/Zynforge Recording.app`; its built and installed in-app runs each passed 371/0 and [GitHub run 35841647969](https://github.com/jeanpierreboutros-lang/ZynforgeRecording/actions/runs/35841647969) passed. A disposable rolling-take navigation/punch test has not been performed. Native UI geometry warnings, physical devices, actual power loss and the planned three-hour/56-input rehearsal remain unverified. See [SHOW-READINESS.md](SHOW-READINESS.md) and [INSTALL.md](INSTALL.md).
