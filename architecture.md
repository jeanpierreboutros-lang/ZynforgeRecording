...
Current validation (2026-09-20): the universal Release build and matching protocol-v3 helper are installed locally. The in-app runner passes 358 test groups with zero failures; the invariant and design audits and final diff checks are clean. Physical hardware acceptance remains separate and pending; see [AUDIT_FIXES_2026-09-20.md](AUDIT_FIXES_2026-09-20.md), [testing.md](testing.md), [INSTALL.md](INSTALL.md) and [SHOW-READINESS.md](SHOW-READINESS.md).
