...
Communicate software validation and show acceptance separately. The current 350-test universal Release/sanitizer build is pushed and installed, and is ready for rehearsal; the planned SD5/56-input rig still needs hardware and three-hour acceptance checks. See [AUDIT_REPORT_2026-09-15.md](AUDIT_REPORT_2026-09-15.md), [INSTALL.md](INSTALL.md) and [SHOW-READINESS.md](SHOW-READINESS.md). Existing visual specifications and historical contrast results below are not a fresh accessibility or hardware certification.
